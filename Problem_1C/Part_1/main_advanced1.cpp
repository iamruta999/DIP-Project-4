...
//Problem 1C_Part1
// This code trains the optical character recognition (OCR) system on the adbvanced test image 1
#include <iostream>
#include <stdio.h>
#include <stdlib.h>
#include <cmath>
...
int main()
{
    ...
    int height = 360;
    int bytesPerPixel = 3;
    char *argv[] = {"Test_night.raw","equalized.raw","segment1.raw","segment2.raw","segment3.raw","segment4.raw","segment5.raw","segment6.raw","segment7.raw","segment8.raw","segment9.raw","segment10.raw","segment11.raw","segment12.raw","segment13.raw"};
    ...
    threshold(gray, thresholdedImage, 90, 255, THRESH_BINARY_INV);
        
    //Crop the image by specifying the co-ordinates of the ROI
    int xStarting = 40;
    int yStarting = 72;
    ...
    regionOfInterest.width = 195;
    regionOfInterest.height = 255;
    Mat croppedImage = thresholdedImage(regionOfInterest);
    ...
    Mat thresholdedColor, duplicateThresholdedImage;
    ...
    int eulerNumber[13] = {1,0,1,1,1,1,1,1,0,1,1,0,1};
    ...
    for (int index = 0; index < contours.size(); index++)
    {
        ...
        //cout << "enter this : " << newHeight << "\t" << newWidth << endl;
        //cout << x << "\t" << y << "\t" << newHeight << "\t" << newWidth << endl;
